        ...
        <div class="utama">
            ...
            <table cellspacing="1" align="center" border="1">
                ...
                $bulan = substr($bulan_sekarang, 5, 2);
                    ...
                    $sql = mysqli_query($con, "SELECT SUM(hadir) AS hadir, SUM(sakit) AS sakit, SUM(ijin) AS izin, SUM(alpa) AS alpa , nis, nama, rombel, rayon, tgl_absen, id_rombel FROM query_absen WHERE id_rombel='$_GET[rombel]' GROUP BY nis");
                    $no = 0;
